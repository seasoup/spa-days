...
module.exports = {
  connect : function ( app, crud ) {
    ...
    // helper function to broadcast to all connected clients and
    // emit to the initiating socket
    //
    ...
    // sign_on and sign_off are helper function to
    // update the is_online property in mongo for a provided user_id
    //
    sign_on = function ( user_id ) {
      crud.update(
        'users',
        { '_id' : user_id },
        { is_online : true },
    ...
    io
      ...
      .on( 'connection', function ( socket ) {
        ...
        // the revised user list to all clients.
        //
        ...
        // TODO: intestigate overlap between disconnect and 'leavechat'
