  ...
  connect : function ( app, crud ) {
    ...
    sign_off = function ( name ) {
      crud.update(
        ...
        { 'name' : name },
        { $set: { is_online: false } },
        function ( result_list ) { emit_user_list(); }
      );
    };
    ...
    emit_user_list = function ( socket ) {
      ...
      crud.read(
        ...
        function ( result_list ) {
          socket.broadcast.emit( 'userchange', result_list );
          socket.emit( 'userchange', result_list );
        }
      );
    };
    ...
    io
      ...
      .on( 'connection', function ( socket ) {
        ...
        // this replaces the 'leavechat' function, as it always works
        // unless the server is closed.  If the server /is/ restarted,
        // I am not quite sure what should happen...
